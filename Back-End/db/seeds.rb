...
mt2 = Top.create(designer: "Nike", name: "27. Nike Pro", score: 2, img_url: "https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/cqlbhl3d0txkepbdlcpk/pro-mens-tight-fit-long-sleeve-top-N8szFc.jpg")
...
mt4 = Top.create(designer: "Nike", name: "29. Nike Therma Repel", score: 5, img_url: "https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/t1bbzz9ri9fk8yjui8p2/therma-repel-mens-1-2-zip-golf-top-hZR66d.jpg")
...
ms5 = Shoe.create(designer: "Nike", name: "30. Nike Air Zoom Pegasus 36 FlyEase", score: 1, img_url: "https://c.static-nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/39530e3c-2330-48b9-a7a6-72eb0e8c35ae/air-zoom-pegasus-36-flyease-mens-running-shoe-1Fb6sV.jpg")
p "Shoes were seeded!"

o1 = Outfit.create(name: "Basic", season: "Spring", likes: 8, top_id: 10, bottom_id: 3, shoe_id: 6)
o2 = Outfit.create(name: "Lazy", season: "Fall", likes: 10, top_id: 3, bottom_id: 9, shoe_id: 4)
o3 = Outfit.create(name: "Athlesure", season: "Summer", likes: 7, top_id: 6, bottom_id: 2, shoe_id: 2)
p "Outfits were seeded"

c0 = Comment.create(name:"Sam", text: "wutttt", outfit_id: 1)
c1 = Comment.create(name:"Komal", text: "I'd wear this", outfit_id: 1)
...
c6 = Comment.create(name:"Lee", text: "6969 occasion", outfit_id: 2)
c7 = Comment.create(name:"Greg", text: "I like it!", outfit_id: 3)
c8 = Comment.create(name:"Halton", text: "I'd fk with that", outfit_id: 3)
c9 = Comment.create(name:"David L.", text: "s/o to mama Lee for the care package", outfit_id: 1)
c10 = Comment.create(name:"Adit", text: "I had my cereal with this outfit", outfit_id: 2)
c11 = Comment.create(name:"Jorge", text: "I see you", outfit_id: 1)
c12 = Comment.create(name:"Lou", text: "Poppin!", outfit_id: 2)
c13 = Comment.create(name:"Mike", text: "Nice!", outfit_id: 3)
c14 = Comment.create(name:"David S.", text: "My quarentine outfit", outfit_id: 2)
c15 = Comment.create(name:"Yoan", text: "I'm hungover", outfit_id: 1)
c16 = Comment.create(name:"Steven", text: "This is cute! Now buy my table", outfit_id:4)
c17 = Comment.create(name:"Sean", text: "I need this", outfit_id: 4)
c18 = Comment.create(name:"Kelly", text: "LOVE IT!", outfit_id: 4)
